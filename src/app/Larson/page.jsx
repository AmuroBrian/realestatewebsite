...
export default function GentryFloorPlans() {
  ...
  const plans = [
   
    {
      ...
      image: '/images/larson1.jpg',
      link: '/images/larson1.jpg',
  
    },
    {
      title: '2 Bedroom Floor Plan',
      image: '/images/larson2.jpg',
      link: '/images/larson2.jpg',
     
    },
     {
      title: '2 Bedrooms Prime Floor Plan',
      image: '/images/larson3.jpg',
      link: '/images/larson3.jpg',
     
    },
     {
     title: '3 Bedrooms Floor Plan',
      image: '/images/larson4.jpg',
      link: '/images/larson4.jpg',
  ...
  return (
    ...
    <div className="bg-gradient-to-b from-amber-50 to-orange-100 px-6 py-16 sm:px-12 lg:px-24">
      ...
      <div className="text-center mb-16">
        ...
        >
          Larsen Tower by Rockwell Primaries
        </motion.h2>
        <motion.p
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
