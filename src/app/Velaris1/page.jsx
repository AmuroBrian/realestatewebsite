...
export default function GentryFloorPlans() {
  const plans = [
    {
      title: 'Location Map',
      image: '/images/velmp.jpg',
      link: '/images/velmp.jpg',
     

    },
    {
      title: 'Location Map',
      image: '/images/velmp1.jpg',
      link: '/images/velmp1.jpg',
     

    },
    {
      title: 'Location Map',
      image: '/images/velmp2.jpg',
      link: '/images/velmp2.jpg',
     

    },
    {
      title: 'Location Map',
      image: '/images/velmp3.jpg',
      link: '/images/velmp3.jpg',

    },
    {
      title: 'Location Map',
      image: '/images/velmp4.jpg',
      link: '/images/velmp4.jpg',
  ...
  return (
    <div className="bg-gradient-to-b from-amber-50 to-orange-100 px-6 py-16 sm:px-12 lg:px-24">
      ...
      <div className="text-center mb-16">
        ...
        >
          The Velaris Residence Informations
        </motion.h2>
        <motion.p
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
