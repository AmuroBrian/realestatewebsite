...
export default function GentryFloorPlans() {
  ...
  const plans = [
    {
      title: 'Location Map',
      image: '/images/larsonmap.jpg',
      link: '/images/larsonmap.jpg',
     

    },
    {
      title: 'Location Map',
      image: '/images/larsonmap1.jpg',
      link: '/images/larsonmap1.jpg',
  ...
  return (
    ...
    <div className="bg-gradient-to-b from-amber-50 to-orange-100 px-6 py-16 sm:px-12 lg:px-24">
      ...
      <div className="text-center mb-16">
        ...
        >
          Larsen Tower by Rockwell Primaries Informations
        </motion.h2>
        <motion.p
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
