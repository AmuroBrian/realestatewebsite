...
const DEVELOPMENTS = [
  {
    title: 'The Arton by Rockwell',
    image: '/images/arton.jpg',
    description: `Rockwell is revolutionizing the Philippine real estate industry by enhancing everyday living through thoughtfully designed experiences that cater to the diverse needs, preferences, and aspirations of its residents and stakeholders. Its vision is to build exceptional communities that go beyond the ordinary, while its mission is to deliver joyful and memorable experiences every day.`,
    properties: [
      { name: 'Location Map', img: '/images/artoon.jpg', url: '/Arton1', description: 'Sophisticated residential building with high-quality features' },
      { name: 'Unit Plans', img: '/images/artoon.jpg', url: '/Arton', description: 'Premium housing tower with deluxe services' },
    ],
    accentColor: 'from-amber-600 to-amber-800'
  },
  {
    title: 'Larsen Tower by Rockwell Primaries',
    image: '/images/Larsoon.jpg',
    description: `Discover the allure of this 9.7-hectare sanctuary in Muntinlupa, where beautiful scenery blends seamlessly with the modern comforts of the Fordham and Larsen Towers. Designed for those who value a peaceful and well-rounded lifestyle, this community offers resort-style amenities and a dedicated retail strip for added convenience.`,
    properties: [
      { name: 'Location Map', img: '/images/larsooon.jpg', url: '/Larson1', description: 'Exclusive residential skyscraper with world-class features' },
      { name: 'Unit Plans', img: '/images/larsooon.jpg', url: '/Larson', description: 'Stylish condo residence offering premium perks' },
    ],
    accentColor: 'from-amber-600 to-amber-800'
  },
  {
    title: 'Edades West',
    image: '/images/edades123.jpg',
    description: `Edades West stands as an iconic masterpiece in Rockwell Center Makati. Merging elegance, functionality, and visionary design, it redefines sophistication, safety, and well-being in modern condominium living. Residents enjoy spacious units and top-notch amenities, all designed to elevate the contemporary lifestyle.`,
    properties: [
      { name: 'Location Map', img: '/images/eds.jpg', url: '/Edades1', description: 'Designer residence featuring premium lifestyle options' },
      { name: 'Unit Plans', img: '/images/eds.jpg', url: '/Edades', description: 'Refined high-rise housing with elite living standards' },
    ],
    accentColor: 'from-amber-600 to-amber-800'
  }
];
