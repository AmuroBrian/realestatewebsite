...
const DEVELOPMENTS = [
  {
    ...
    properties: [
      { name: 'Location Map', img: '/images/sie1.jpg', url: '/Sierra1', description: 'Sophisticated residential building with high-quality features' },
      { name: 'Unit Plans', img: '/images/sie1.jpg', url: '/Sierra', description: 'Premium housing tower with deluxe services' },
    ],
    accentColor: 'from-amber-600 to-amber-800'
  },
  {
    title: 'The Sapphire Bloc',
    image: '/images/sappp.jpg',
    ...
    properties: [
      { name: 'Location Map', img: '/images/XDD.jpg', url: '/Sapphire1', description: 'Exclusive residential skyscraper with world-class features' },
      { name: 'Unit Plans', img: '/images/XDD.jpg', url: '/Sapphire', description: 'Stylish condo residence offering premium perks' },
    ],
    accentColor: 'from-amber-600 to-amber-800'
  },
  {
